var editsMenu;
var editor;
import addToGroup from './editsMenu';
beforeAll(() => {
...
it("should add the edit into a group if a group is specified", () => {
    jest.spyOn(window, 'prompt').mockImplementation(() => "Group A");

    var edit=new Edit("","Hello",1);
      console.log(editsMenu.edits)
      editsMenu.edits[0]=edit;
      editsMenu.addToGroup(1);
      expect(edit.group).toContain("Group A");
  });

  it("should not add the edit into a group if no group is specified", () => {
