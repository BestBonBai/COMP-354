var editsMenu;
var editor;
import editSelected from './editsMenu';
...
it("Should set an edit's 'selected value' to be true", () =>{
    var edit=new Edit("","Hello",1);
    console.log(editsMenu.edits)
    editsMenu.edits[0]=edit;
    document.body.innerHTML = '<div id="edit1Selected"><div id="deleteEdits"><div id="performEdits"></div></div></div>';
