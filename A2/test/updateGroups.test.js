var editsMenu;
var editor;
import updateGroups from './editsMenu';
beforeAll(() => {
...
it("should remove useless groups where none of the edits are placed", () => {
    editsMenu.groups=['Group A','Group B'];
    var edit=new Edit("","Hello",1);
    console.log(editsMenu.edits)
    edit.group="Group A";
    editsMenu.edits[0]=edit;
    editsMenu.updateGroups()
    expect(editsMenu.groups).toEqual(['Group A']);
  });

  it("should not remove any groups where at least one of the edits is pushed", () => {
    editsMenu.groups=['Group A','Group B'];
    var edit=new Edit("","Hello",1);
    var edit2=new Edit("","Hello2",2);
    console.log(editsMenu.edits)
    edit.group="Group A";
    edit2.group="Group B";
    editsMenu.edits[0]=edit;
    editsMenu.edits[1]=edit2;
    editsMenu.updateGroups()
    expect(editsMenu.groups).toEqual(['Group A','Group B']);
  });
