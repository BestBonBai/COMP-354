...
import deleteEdits from'./editsMenu';
...
editsMenu = new EditsMenu(editor, options);
  ...
  it("Should remove the selected object from the stack manager", () =>{
      var edit=new Edit("","Hello",1);
      console.log(editsMenu.edits)
      editsMenu.edits[0]=edit;
      editsMenu.deleteEdits()
  ...
  it("Should remove the selected object from the stack manager", () =>{
    ...
    editsMenu.deleteEdits()
    expect(editsMenu.edits[1]).toBeUndefined();
});